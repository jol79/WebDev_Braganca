...
<div class="container">
    ...
    <div class="row col-2-lg" style="">
        ...
        <div class="col" style="margin-top: 50px">
            ...
            <a href="#" class="btn btn-primary button_params cube__button" style="border-radius: 24px; margin-top: 20px; margin-left: 0px; padding-bottom: 30px; background: #616DE1">Learn</a>
            ...
            <a href="#" class="btn btn-primary button_params cube__button" style="border-radius: 24px; margin-top: 20px; margin-left: 0px; padding-bottom: 30px; ; background: #616DE1">Create</a>
            ...
            <a href="#" class="btn btn-primary button_params cube__button" style="border-radius: 24px; margin-top: 20px; margin-left: 0px; padding-bottom: 30px; background: #616DE1">Read</a>
            ...
            <a href="#" class="btn btn-primary button_params cube__button" style="border-radius: 24px; margin-top: 20px; margin-left: 0px; padding-bottom: 30px; background: #616DE1">Feedback</a>
        ...
        <div class="col">
            <div class="scene pos__cube">
                <div class="cube cube__spin">
                    ...
                    <!--Golang-->
                    <div class="cube__face cube__face--right cube__text"">
                        <div style="margin-left: -30px; margin-top: -30px">
                            <img class="goLogo" src="https://assets.algoexpert.io/g67f39aee9a-prod/dist/images/goLogo.png?a54b64a0" alt="golang">
                        </div>
                    </div>
                    <!-- C++ (empty because of svg size) -->
                    <div class="cube__face cube__face--left cube__text">
